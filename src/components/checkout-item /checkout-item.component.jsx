...
function CheckoutRow({ cartItem }) {
  ...
  const {addItemtoCart, removeItemfromCart, cancelItemfromCart} = useContext(CartContext)
  ...
  return (
    <div>
      ...
      <div className="checkout-item-container">
       ...
       <div className = 'arrow' onClick={decItem}>&#10095;</div>
        ...
        <div className="remove-button" onClick={cancelItem}>&#10005;</div>
      </div>
